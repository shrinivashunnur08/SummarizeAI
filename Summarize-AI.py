...
prompt = """
You are a YouTube video summarizer. Your task is to read the provided transcript and create a concise summary of the video's content in English. Please condense the key points and main ideas into a list of bullet points, ensuring the summary can be 500-1500 words or can be Longer. Use clear and precise language. 
